...
# start checking
print(
	"""This file will check that your agent has the correct function definitions and can perform
...
try:
	...
	print(
		" 3.2 Agent runs basic parameterized_minimax() without error and returns correct format ✓"
	)
except Exception:
...
try:
	state = TTS_State.TTS_State(board)
	results = Player.parameterized_minimax(
		current_state=state, max_ply=2, use_alpha_beta=True, use_basic_static_eval=True
	)
